...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(onboarding)/_layout` | `/_layout` | `/(onboarding)/address` | `/address` | `/(onboarding)/bio` | `/bio` | `/(onboarding)/jobs` | `/jobs` | `/(onboarding)/location` | `/location` | `/(onboarding)/onboarding` | `/onboarding` | `/(onboarding)/provider-type` | `/provider-type` | `/(onboarding)/shops` | `/shops` | `/(onboarding)/welcome-provider` | `/welcome-provider` | `/(onboarding)/welcome` | `/welcome` | `/(register)/_layout` | `/(register)/attempt` | `/attempt` | `/(register)/login` | `/login` | `/(register)/password` | `/password` | `/(register)/prepare` | `/prepare` | `/(register)/register` | `/register` | `/(register)/success` | `/success` | `/(tabs)/(profile)/_layout` | `/(tabs)/(profile)/change-password` | `/change-password` | `/(tabs)/(profile)/edit-address` | `/edit-address` | `/(tabs)/(profile)/edit-bio` | `/edit-bio` | `/(tabs)/(profile)/edit-locations` | `/edit-locations` | `/(tabs)/(profile)/edit-user-profile` | `/edit-user-profile` | `/(tabs)/(profile)/gallery` | `/gallery` | `/(tabs)/(profile)/leave-review` | `/leave-review` | `/(tabs)/(profile)/reviews` | `/reviews` | `/(tabs)/(profile)/user-profile` | `/user-profile` | `/(tabs)/(profile)/user-settings` | `/user-settings` | `/(tabs)/_layout` | `/(tabs)/home` | `/home`;
  // prettier-ignore
